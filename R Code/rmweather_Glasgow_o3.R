library(remotes)
setwd('C:\\Users\\csy\\OneDrive - Imperial College London\\MSc Tansport\\Dissertation\\Environment\\Coronavirus\\R\\Weather Normalisation\\Dissertation\\Glasgow\\Glasgow_O3')
...
o3 <- read.csv('Glasgow_Townhead-o3.csv',head = TRUE)
...
mydata <- left_join(Glasg_meteo, o3, by = "date")

# Save the already prepared dataset
write.csv(mydata,'Glasg_meteo+o3.csv')
...
write.csv(data_Glasg_prepared,'Glasgow_meteo+o3_DeNA.csv')
