library(remotes)
setwd('C:\\Users\\csy\\OneDrive - Imperial College London\\MSc Tansport\\Dissertation\\Environment\\Coronavirus\\R\\Weather Normalisation\\Dissertation\\Manchester\\Manchester_O3')
...
o3 <- read.csv('ManchesterPiccadilly-o3.csv',head = TRUE)
...
mydata <- left_join(Manche_meteo, o3, by = "date")

# Save the already prepared dataset
write.csv(mydata,'Manche_meteo+o3.csv')
...
write.csv(data_Manche_prepared,'Manchester_meteo+o3_DeNA.csv')
